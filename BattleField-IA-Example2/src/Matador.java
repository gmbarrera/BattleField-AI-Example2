...
public class Matador extends Warrior {
        ...
        public Matador(String name, int health, int defense, int strength, int speed, int range) throws RuleException {
        ...
        public Action playTurn(long tick, int actionNumber) {
                ...
                if (actionNumber == 1) {
                        ...
                        MatadorMove move = new MatadorMove();
